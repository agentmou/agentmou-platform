...
const tenantStates: Record<HonestSurfaceId, HonestSurfaceState> = {
  ...
  'security-secrets': createState(
    'not-yet-available',
    'Secrets surface not yet available',
    'Secrets management is not wired to a tenant-facing backend workflow in this workspace yet.',
  ),
  ...
  'security-audit': createState(
    'not-yet-available',
    'Audit export not yet available',
    'Audit history and export controls need backend wiring before they can be used from the tenant UI.',
  ),
  ...
  'settings-billing': createState(
    ...
    'Billing cards are placeholder-backed until real billing and usage data are available in the tenant UI.',
  ),
  ...
  'n8n-connection': createState(
    ...
    'n8n is managed internally by Agentmou today and is not exposed as a tenant-managed surface.',
  ),
  ...
  'chat-assistant': createState(
    'demo',
    'Assistant demo',
    'Assistant replies are generated by a mock engine and should be treated as guided product copy, not live execution.',
  ),
};
