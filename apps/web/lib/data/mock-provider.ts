...
import {
  ...
  changeAdminTenantStatus as _changeAdminTenantStatus,
...
export const mockProvider: DataProvider = {
  ...
  changeAdminTenantStatus: async (_adminTenantId, managedTenantId, body) =>
    _changeAdminTenantStatus(managedTenantId, body),
