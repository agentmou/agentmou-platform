...
export default function RunsListPage() {
  ...
  const uniqueAgentIds = [...new Set(runs.map((run) => run.agentId).filter(Boolean))] as string[];
  ...
  const getStatusType = (
    status: string
  ): 'success' | 'error' | 'running' | 'pending' | 'warning' => {
    switch (status) {
      case 'success':
        return 'success';
      case 'failed':
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                <DropdownMenuItem asChild>
                                  <Link href={`/app/${tenantId}/runs/${run.id}`}>View details</Link>
                                </DropdownMenuItem>
                                <DropdownMenuSeparator />
