...
export default function PackDetailPage() {
  ...
  includedAgentDetails.forEach((a) =>
    a.requiredIntegrations.forEach((i) => allRequiredIntegrations.add(i))
  );
  includedWorkflowDetails.forEach((w) =>
    w.integrations.forEach((i) => allRequiredIntegrations.add(i))
  );
                ...
                <CardHeader>
                  <div className="flex items-center gap-2">
                    <CardTitle className="text-base">
                      Required Integrations ({requiredIntegrationDetails.length})
                    </CardTitle>
