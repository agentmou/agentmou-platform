...
export default function AgentDetailPage() {
  ...
  const requiredIntegrations = integrations.filter((i) =>
    agent.requiredIntegrations.includes(i.id)
  );
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              {agent.channel === 'beta' && <Badge variant="outline">beta</Badge>}
            </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              <p>
                This agent has a <strong className="text-foreground">{agent.riskLevel}</strong> risk
                level.
              </p>
              {agent.hitl === 'required' && (
              ...
              {agent.hitl === 'recommended' && (
                <p>Human approval is recommended for sensitive actions.</p>
              )}
            </CardContent>
          </Card>
        </div>
