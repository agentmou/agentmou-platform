...
export async function billingRoutes(fastify: FastifyInstance) {
  ...
  fastify.get(
    ...
    async (
      ...
      return reply.send(
        BillingSubscriptionResponseSchema.parse({ subscription }),
      );
    },
  );
  ...
  fastify.put(
    ...
    async (
      ...
      return reply.send(
        BillingSubscriptionResponseSchema.parse({ subscription: result }),
      );
    },
  );
  ...
  fastify.get(
    ...
    async (
      ...
      return reply.send(
        BillingPaymentMethodsResponseSchema.parse({ methods }),
      );
    },
  );
