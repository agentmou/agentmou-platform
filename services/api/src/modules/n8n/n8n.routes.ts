...
export async function n8nRoutes(fastify: FastifyInstance) {
  ...
  fastify.get(
    '/tenants/:tenantId/n8n/workflows',
  ...
  fastify.get(
    '/tenants/:tenantId/n8n/workflows/:workflowId',
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  fastify.post(
    '/tenants/:tenantId/n8n/workflows/import',
    async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  fastify.get(
    '/tenants/:tenantId/n8n/workflows/:workflowId/export',
    async (request: FastifyRequest, reply: FastifyReply) => {
      const { workflowId } = request.params as { workflowId: string };
  ...
  fastify.post(
    '/tenants/:tenantId/n8n/workflows/:workflowId/execute',
    async (request: FastifyRequest, reply: FastifyReply) => {
      const { workflowId } = request.params as { workflowId: string };
  ...
  fastify.post(
    '/tenants/:tenantId/n8n/workflows/:workflowId/activate',
    async (request: FastifyRequest, reply: FastifyReply) => {
      const { workflowId } = request.params as { workflowId: string };
  ...
  fastify.post(
    '/tenants/:tenantId/n8n/workflows/:workflowId/deactivate',
    async (request: FastifyRequest, reply: FastifyReply) => {
      const { workflowId } = request.params as { workflowId: string };
